...
{	
    ...
    // Constraint mode
    public Vector3 constraintValues;
...
//					initialRotations[(int)KinectWrapper.SkeletonJoint.LEFT_ELBOW];
    ...
    void TransformBone(uint userId, KinectWrapper.SkeletonJoint joint, int boneIndex, bool flip)
    {
        ...
        newRotation = new Quaternion(constraintValues.x * newRotation.x, constraintValues.y * newRotation.y, constraintValues.z * newRotation.z, newRotation.w);
